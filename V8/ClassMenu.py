...
class Menus:
    def main_menu(mapa):
        ...
        while True:
            ...
            Textos.texto_pantalla_rect('Menú', Textos.fuentes(si,80),Blanco,Pant,(Pant.get_width()/2)-75, 20)
            ...
            Textos.texto_pantalla_rect('JUEGO', Textos.fuentes(si,50), Blanco, Pant, (Pant.get_width()/2)-60, 110)
            Textos.texto_pantalla_rect('OPCIONES', Textos.fuentes(si,50), Blanco, Pant, (Pant.get_width()/2)-90, 210)
