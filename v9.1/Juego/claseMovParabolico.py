                ...
                if (int(bala.y) >= ancho) or (int(bala.x) >= largo) or (int(bala.y) <= 0) or (int(bala.x) <= 0):
                    ...
                    if Turno[0] == 1:
                        if EleccionbalaAzul[0] == 1:
                            pygame.draw.circle(Pant, (255, 255, 0), (int(bala.x), int(bala.y)), 15)
                        elif EleccionbalaAzul[0] == 2:
                            pygame.draw.circle(Pant, (204, 99, 0), (int(bala.x), int(bala.y)), 10)
                        elif EleccionbalaAzul[0] == 3:
                            pygame.draw.circle(Pant, (0, 0, 0), (int(bala.x), int(bala.y)), 5)
                    elif Turno[0] == 2:
                        if EleccionbalaRojo[0] == 1:
                            pygame.draw.circle(Pant, (255, 255, 0), (int(bala.x), int(bala.y)), 5)
                        elif EleccionbalaRojo[0] == 2:
                            pygame.draw.circle(Pant, (204, 99, 0), (int(bala.x), int(bala.y)), 5)
