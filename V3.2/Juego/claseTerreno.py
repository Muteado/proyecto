...
import pygame
import random
from .Variables import Pant, Celeste, Verde, largo, ancho, cmi, cmd, ccd, cci
from .ClassRectangulos import Rectangulos
from .claseTanques import imagen, imagen2, rect, rest, estado
...
class Terreno:
    ...
    def run(mapa):
        ...
        Tanque.dibujar_tanque(imagen, rect)
        Tanque.dibujar_tanque(imagen2, rest)
        return mapa
        ...
        while y < 600:
            while x < 1280:
                if base[y][x] == 0:
                    ...
                    Tanque.dibujar_tanque_Azul(Pant,x,y)
                elif base[y][x] == 3:
                    Tanque.dibujar_tanque_Rojo(Pant,x,y)    
                x += 1
            x = 0
            y += 1
