...
class Menus:
    def main_menu(mapa):
        ...
        while True:
            ...
            boton1 = Rectangulos.rectangulo((Pant.get_width()/2)-150, 100, 300, 50) #NUEVA PARTIDA #x #y #ancho #alto
            boton2 = Rectangulos.rectangulo((Pant.get_width()/2)-150, 200, 300, 50) #INSTRUCCIONES
            boton3 = Rectangulos.rectangulo((Pant.get_width()/2)-150, 300, 300, 50) #OPCIONES
            ...
            if iniciada == False:
                ...
                Textos.texto_pantalla_rect('JUGAR', Textos.fuentes(None,50), Negro, Pant, (Pant.get_width()/2)-60, 110)
            if iniciada == True:
                #En caso de ser una partida ya en juego
                Textos.texto_pantalla_rect('NUEVA PARTIDA', Textos.fuentes(None,50), Negro, Pant, (Pant.get_width()/2)-140, 110)
            Textos.texto_pantalla_rect('INSTRUCCIONES', Textos.fuentes(None,50), Negro, Pant, (Pant.get_width()/2)-145, 210)
            Textos.texto_pantalla_rect('OPCIONES', Textos.fuentes(None,50), Negro, Pant, (Pant.get_width()/2)-90, 310)
