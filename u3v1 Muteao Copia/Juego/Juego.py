...
class Juego:
    def juego(Pant,ang_AZUL,vel_AZUL,mapa):
        ...
        if x == 0:
            ...
            DatosEsquinas.textosEsquinas(ang_AZUL,rectTXT1A,color,activo1A)#Angulo ROJO
            DatosEsquinas.textosEsquinas(vel_AZUL,rectTXT2A,color,activo2A)#Velocidad ROJO
        ...
        while salir!=True:
            ...
            if Turno[0] == 1:
                Turnos.stockbalas(balaspj1, color)
                
            if Turno[0] == 2:
                Turnos.stockbalas(balaspj2, color2)
                                    ...
                                    if Velocidad_Azul[0] != str and Angulo_Azul[0] != str:
                                        if Velocidad_Azul[0] > 0 and Velocidad_Azul[0] < 201:
                                            if Angulo_Azul[0] >= 0 and Angulo_Azul[0] <= 180:
                                                aux = True
                                                Lanzamiento.lanzamiento(botonamarillo,botonnaranja,botonmorado,aux)
                                                vel_AZUL = ''
                                                ang_AZUL = ''
                                                Angulo_Azul[0] = ''
                                                Velocidad_Azul[0] = ''
