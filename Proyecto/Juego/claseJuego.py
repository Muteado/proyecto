...
from .ClassDatos import Entrada

class Juego:
    def juego(Pant,aux,ang_ROJO,vel_ROJO,ang_AZUL,vel_AZUL,mapa):  # DIS_ROJO, DIS_AZUL
        ...
        #disr = Rectangulos.rectangulo(Pant.get_width()-largoBloq/2-15, posIniY+64,largoBloq,altoBloq)#disparar
        ...
        #disa = Rectangulos.rectangulo(posIniX+largoBloq/2-15, posIniY+64,largoBloq,altoBloq)#disparar 
        ...
        while salir!=True:
            ...
            #DIS_ROJO = DatosEsquinas.textosEsquinas(DIS_ROJO,disr,Azul,activdR)
            ...
            #DIS_AZUL = DatosEsquinas.textosEsquinas(DIS_AZUL,disa,Azul,activdA)
