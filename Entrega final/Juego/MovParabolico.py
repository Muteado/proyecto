...
class Lanzamiento:
    ...
    def lanzamiento(jugador,botonamarillo,botonnaranja,botonmorado,mapa):
        ...
        while mientras:
            ...
            if bala.disparar == True:
                ...
                #Se ve si la bala de 105 mm impacta contra el terreno
                    ...
                    mientras = Movimiento.validaimpactos(10,bala, 50,jugador,mapa)
                    

                #Se valida si la bala perforante impactó en el terreno
                elif botonnaranja == True:
                    mientras = Movimiento.validaimpactos(7,bala, 40,jugador,mapa)
                
                #Se valida si la bala 60 mm impactó en el terreno
                elif botonmorado == True:
                    mientras = Movimiento.validaimpactos(5,bala,30,jugador,mapa)


                    
                if jugador1.get_Vida() <= 0 and jugador == jugador1 and jugador1.get_Estado() == True:
                    jugador.kill -= 1
                ...
                if jugador2.get_Vida() <= 0 and jugador == jugador2 and jugador2.get_Estado() == True:
                    jugador.kill -= 1
                ...
                if jugador3.get_Vida() <= 0 and jugador == jugador3 and jugador3.get_Estado() == True:
                    jugador.kill -= 1
                ...
                if jugador4.get_Vida() <= 0 and jugador == jugador4 and jugador4.get_Estado() == True:
                    jugador.kill -= 1
                ...
                if jugador5.get_Vida() <= 0 and jugador == jugador5 and jugador5.get_Estado() == True:
                    jugador.kill -= 1
                ...
                if jugador6.get_Vida() <= 0 and jugador == jugador6 and jugador6.get_Estado() == True:
                    jugador.kill -= 1
                ...
                if jugador1.get_Vida() <= 0 and jugador1.get_Estado() == True:
                    jugador1.set_Estado(False)
                    Borrar_Tanque(jugador1,mapa)

                if jugador2.get_Vida() <= 0 and jugador2.get_Estado() == True:
                    jugador2.set_Estado(False)
                    Borrar_Tanque(jugador2,mapa)

                if jugador3.get_Vida() <= 0 and jugador3.get_Estado() == True:
                    jugador3.set_Estado(False)
                    Borrar_Tanque(jugador3,mapa)

                if jugador4.get_Vida() <= 0 and jugador4.get_Estado() == True:
                    jugador4.set_Estado(False)
                    Borrar_Tanque(jugador4,mapa)

                if jugador5.get_Vida() <= 0 and jugador5.get_Estado() == True:
                    jugador5.set_Estado(False)
                    Borrar_Tanque(jugador5,mapa)

                if jugador6.get_Vida() <= 0 and jugador6.get_Estado() == True:
                    jugador6.set_Estado(False)
                    Borrar_Tanque(jugador6,mapa)
