...
from .Variables import Blanco, Negro, Pant, Amarillo
...
class OpcionesCat:
    ...
    def instrucciones():
        ...
        while instruc:
            ...
            Textos.texto_pantalla_rect('El jugador AZUL debe ingresar el angulo y velocidad,', 
                                        Textos.fuentes(None,50),Blanco,
                                        Pant, 80, 200)
            Textos.texto_pantalla_rect('confirme los datos y elija su tipo de bala,', 
                                        Textos.fuentes(None,50),Blanco,
                                        Pant, 80, 250)
            ...
            Textos.texto_pantalla_rect('Jugador ROJO repita los mismos pasos.', 
                                        Textos.fuentes(None,50),Blanco,
                                        Pant,80, 350)
            Textos.texto_pantalla_rect('Gana quien quede con vida.', 
                                        Textos.fuentes(None,50),Blanco,
                                        Pant,80, 400)
