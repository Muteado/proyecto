...
import random
from .Variables import Celeste, Verde,Azul,Rojo, largo, ancho, XdeTankA,XdeTankR
...
class Terreno:
    ...
    def run(mapa):
        ...
        XdeTankA[0] = random.randint(40,426)
        XdeTankR[0] = random.randint(800,1240)
        Tanque.hacer_tanques(mapa,XdeTankA[0],2)
        Tanque.hacer_tanques(mapa,XdeTankR[0],3)
        return mapa
