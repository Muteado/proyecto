...
from VS1_1 import Amarillo, Blanco, Pant
...
class Menu:
    def main_menu():
        ...
        while True:
            ...
            boton1 = Rectangulos.rectangulos((Pant.get_width()/2)-100, 100, 200, 50) #JUGAR
            boton2 = Rectangulos.rectangulos((Pant.get_width()/2)-100, 200, 200, 50) #OPCIONES
            ...
            Rectangulos.dibujaRectangulos(Pant, Amarillo, boton1)
            Rectangulos.dibujaRectangulos(Pant, Amarillo, boton2)
