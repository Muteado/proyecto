...
class OpcionesCat: 
    def opciones(iniciada):
        ...
        while corriendo:
            ...
            botonNuevo = Rectangulos.rectangulo(largo[0]-150, 20, 100, 50) 
            Rectangulos.dibujaRectangulos(Pant, Amarillo, botonNuevo,0)
            Textos.texto_pantalla_rect('Jugar', Textos.fuentes(None,40), Negro, Pant, largo[0]-140, 30)
            ...
            if boton4.collidepoint((mousex, mousey)):
                if click:
                    if(aboton1 == 0):
                        if(jugadores[0]+IA==6 and IA<=0):
                            Rectangulos.dibujaRectangulos(Pant, Rojo, boton4,0)#jugadores[0] IA
                        elif(jugadores[0]+IA==6 and IA>0):
                            jugadores[0]+=1
                            IA-=1
                        elif(jugadores[0]+IA<6):
                            jugadores[0]+=1
                    else:
                        if(jugadores[0]+IA==6 and jugadores[0]<=0):
                            Rectangulos.dibujaRectangulos(Pant, Rojo, boton4,0)#jugadores[0] IA
                        elif(jugadores[0]+IA==6 and jugadores[0]>0):
                            jugadores[0]-=1
                            IA+=1
                        elif(jugadores[0]+IA<6):
                            IA+=1
