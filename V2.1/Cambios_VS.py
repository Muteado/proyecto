...
font_name = '8-BIT WONDER.TTF'#Definición tipo de fuente
font = pygame.font.SysFont(font_name, 80)#Titulos arriba de la pantalla
font2 = pygame.font.SysFont(font_name, 50)#Nombres botones
font3 = pygame.font.SysFont(font_name, 23)#Textos pequeños
