...
class OpcionesCat:
    def pausa():
        ...
        while pause:
            ...
            #Agrega texto TITULO
            Textos.texto_pantalla_rect('Pause', Textos.fuentes(si,80), Blanco, Pant, (Pant.get_width()/2)-115, 80)
            #Agrega texto informativo a la pantalla
            Textos.texto_pantalla_rect('Presione P para volver al juego', 
                                        Textos.fuentes(si,80),Blanco,
    ...
    def instrucciones():
        ...
        while instruc:
            ...
            Textos.texto_pantalla_rect('MENU ', Textos.fuentes(si,50), Blanco, Pant, (Pant.get_width()/2)-50, 210)
            #Agrega texto informativo a la pantalla
            Textos.texto_pantalla_rect('Para iniciar el juego', 
                                        Textos.fuentes(si,50),Blanco,
                                        Pant, 80, 300)
            Textos.texto_pantalla_rect('ingrese el valor del angulo del usuario que comience', 
                                        Textos.fuentes(si,50),Blanco,
                                        Pant, 80, 350)
            Textos.texto_pantalla_rect('y luego ingrese la velocidad. (Presionando enter para confirmar).', 
                                        Textos.fuentes(si,50),Blanco,
                                        Pant, 80, 400)
            Textos.texto_pantalla_rect('Después el siguiente jugador repita los pasos,', 
                                        Textos.fuentes(si,50),Blanco,
                                        Pant,80, 450)
    ...
    def opciones():
        ...
        while corriendo:
            ...
            #Agrega texto TITULO
            Textos.texto_pantalla_rect('Opciones', Textos.fuentes(si,80), Blanco, Pant, (Pant.get_width()/2)-125, 20)
            ...
            Textos.texto_pantalla_rect('INSTRUCCIONES', Textos.fuentes(si,50), Blanco, Pant, (Pant.get_width()/2)-145, 110)
            #Dibuja el Boton2 en pantalla
            Rectangulos.dibujaRectangulos(Pant,Amarillo,boton2,0)
            #Agrega texto en el boton2
            Textos.texto_pantalla_rect('SALIR', Textos.fuentes(si,50), Blanco, Pant, (Pant.get_width()/2)-50, 210)
