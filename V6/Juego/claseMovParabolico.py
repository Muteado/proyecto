...
from .Variables import XdeTankA, largo, ancho, Pant, mapa, Celeste, X_Tanque_Rojo, Y_Tanque_Rojo, X_Tanque_Azul, Y_Tanque_Azul, Turno, Partida
...
class Proyectil():
    ...
    def lanzamiento(aux):
        ...
        if Turno[0] == 1:
            ...
            if angulo == 90:
                bala = Proyectil(X_Tanque_Azul[0], Y_Tanque_Azul[0]-10, angulo, velocidad)#velocidad,angulo
            if angulo > 90:
                bala = Proyectil(X_Tanque_Azul[0]-20, Y_Tanque_Azul[0], angulo, velocidad)#velocidad,angulo
            ...
            velocidad = int(input('Ingrese velocidad bala: '))
            if angulo < 90:
                bala = Proyectil(X_Tanque_Rojo[0]+20, Y_Tanque_Rojo[0], angulo, velocidad)#velocidad,angulo
            if angulo == 90:
                bala = Proyectil(X_Tanque_Rojo[0], Y_Tanque_Rojo[0]-10, angulo, velocidad)#velocidad,angulo
            if angulo > 90:
                bala = Proyectil(X_Tanque_Rojo[0]-20, Y_Tanque_Rojo[0], angulo, velocidad)#velocidad,angulo
