...
class DatosEsquinas:
    def generarBloques(posIniX,posIniY,largoBloq,altoBloq):
        ...
        Textos.texto_pantalla_rect('Ángulo :', Textos.fuentes(si,23), Blanco, Pant, posIniX+5,posIniY+5)
        Textos.texto_pantalla_rect('Velocidad :', Textos.fuentes(si,23), Blanco, Pant, posIniX+5,posIniY+26)
        Textos.texto_pantalla_rect('Metros:', Textos.fuentes(si,23), Blanco, Pant, posIniX+5,posIniY+46)
        #Genera textos rojos
        Textos.texto_pantalla_rect('Ángulo :', Textos.fuentes(si,23), Blanco, Pant, Pant.get_width()-largoBloq+5,posIniY+5)
        Textos.texto_pantalla_rect('Velocidad :', Textos.fuentes(si,23), Blanco, Pant, Pant.get_width()-largoBloq+5,posIniY+26)
        Textos.texto_pantalla_rect('Metros:', Textos.fuentes(si,23), Blanco, Pant, Pant.get_width()-largoBloq+5,posIniY+46)
